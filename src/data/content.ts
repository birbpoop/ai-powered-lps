...
export const dialogueGrammar: GrammarPoint[] = [
  {
    pattern: "A-not-A（正反問句）",
    level: 2,
    english: "A-not-A question pattern for yes/no questions",
    example: "你喜歡不喜歡喝咖啡？",
  },
  {
    pattern: "要是……就……",
    ...
    example: "你要是發燒，今天就在家休息吧。",
  },
  {
    pattern: "不但……而且……",
    level: 3,
    english: "Not only... but also...",
    example: "這個故事不但容易了解，而且很有意思。",
  },
  {
    pattern: "再……也……",
    level: 4,
    english: "No matter how..., still...",
    example: "他很喜歡彈鋼琴，所以平時練習再辛苦也不怕。",
  },
  {
    pattern: "好在",
    level: 5,
    english: "Fortunately / Luckily",
    example: "好在這次還不是正式演出，大家可以再重新練習一遍。",
  },
  {
    pattern: "（可是）話說回來",
    level: 5,
    english: "Having said that / On the other hand",
    example: "人與人相處的確是一件困難的事情，可是話說回來，只要真誠就可以交到好朋友。",
  },
  {
    pattern: "事實上",
    level: 5,
    english: "In fact / Actually",
    example: "一般人認為運動一定可以減肥，事實上，飲食控制才是最重要的。",
  },
];
...
export const essayGrammar: GrammarPoint[] = [
  {
    ...
    example: "我們公司小自買筆，大至投資計畫都由總經理親自決定。",
  },
  {
    pattern: "視……而定",
    level: 5,
    english: "Depend on...",
    example: "房子的價格主要視地點和大小而定。",
  },
  {
    pattern: "既A，也B",
    level: 5,
    english: "Both A and B",
    example: "來臺灣既可以學中文，也可以享受美食。",
  },
  {
    pattern: "於是",
    level: 5,
    english: "Therefore / And so",
    example: "抽煙有害身體健康，於是爸爸決定戒煙。",
  },
  {
    pattern: "反之",
    level: 5,
    english: "Conversely / On the contrary",
    example: "睡前過度運動容易睡不好，反之，聽點音樂可以幫助睡眠。",
  },
  {
    pattern: "竟",
    level: 5,
    english: "Unexpectedly / Surprisingly",
    example: "短短不到幾年的時間，這間公司的資本額竟高達數億美金。",
  },
  {
    pattern: "換句話說",
    level: 5,
    english: "In other words",
    example: "出生率降低了，換句話說，就是孩子越來越少了。",
  },
  {
    pattern: "不是……而是……",
    level: 5,
    english: "Not...but rather...",
    example: "改變命運的關鍵不是靠算命，而是靠自己的努力。",
  },
];
